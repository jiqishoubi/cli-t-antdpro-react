          ...
          <Form.Item label="规格信息" required>
            <div className={styles.skuTable}>
              <div className={styles.skuTitle2}>
                ...
                <span className={styles.td}>商品售价</span>
                    ...
                    return (
                      <div key={index} className={styles.skuTable2_content_div}>
                        ...
                        <span className={styles.td}>
                          ...
                          >
                            <Input size="small" placeholder="请输入供货价" prefix="￥" />
                          </Form.Item>
                        </span>
                        <span className={styles.td}>
                          <Form.Item
                          ...
                          >
                            <Input size="small" placeholder="请输入建议售价" prefix="￥" />
                          </Form.Item>
                        </span>
                        <span className={styles.td}>
                          <Form.Item
                          ...
                          >
                            <Input size="small" placeholder="请输入库存" />
                          </Form.Item>
                        </span>
                        {/* <span className={styles.td}>
                        <Form.Item
